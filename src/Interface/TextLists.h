...
static std::string toplist [] = {
    ...
    "  SOlo [s] [n]",           "channel 'solo' switch type (Row, COlumn, Loop, Twoway, CHannel {other} off)",
...
static std::string addmodlist [] = {
    ...
    "FIXed <s> *-add",      "set modulator frequency to 440Hz (ON, {other})",
