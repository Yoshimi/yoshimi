...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/EnvelopeUI.h"
// Envelope.cc
...
Fl_Double_Window* EnvelopeUI::make_freemode_edit_window() {
  { freemodeeditwindow = new Fl_Double_Window(575, 180, "Envelope");
    ...
    { freemodebutton = new Fl_Light_Button(10, 155, 95, 22, "FreeMode");
    ...
    { WidgetPDial* o = envstretchdial = new WidgetPDial(380, 155, 25, 25, "Str.");
      ...
      o->value(env->Penvstretch);o->setSynth(synth);o->controllable=false;
      if (env->Pfreemode==0) o->hide();
    } // WidgetPDial* envstretchdial
    { Fl_Button* o = new Fl_Button(519, 155, 44, 20, "Close");
...
Fl_Group* EnvelopeUI::make_ADSR_window() {
  { envADSR = new Fl_Group(0, 0, 205, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 205, 70, "Amplitude Env");
...
Fl_Group* EnvelopeUI::make_ASR_window() {
  { envASR = new Fl_Group(0, 0, 210, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 210, 70, "Frequency Env");
      o->box(FL_PLASTIC_UP_BOX);
      o->color(FL_CYAN);
      o->labelfont(1);
      o->labelsize(10);
...
Fl_Group* EnvelopeUI::make_ADSRfilter_window() {
  { envADSRfilter = new Fl_Group(0, 0, 275, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 275, 70, "Filter Env");
      o->box(FL_PLASTIC_UP_BOX);
      o->color(FL_CYAN);
      o->labelfont(1);
      o->labelsize(10);
...
Fl_Group* EnvelopeUI::make_ASRbw_window() {
  { envASRbw = new Fl_Group(0, 0, 210, 70);
    ...
    { Fl_Group* o = new Fl_Group(0, 0, 210, 70, "BandWidth Env");
      o->box(FL_PLASTIC_UP_BOX);
      o->color(FL_CYAN);
      o->labelfont(1);
      o->labelsize(10);
