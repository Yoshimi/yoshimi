...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/LFOUI.h"
// LFOUI.cc
...
void LFOUI::cb_freq_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Pfreq, o->value()*127);
}
...
void LFOUI::cb_intensity_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Pintensity, o->value());
}
...
void LFOUI::cb_delay_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Pdelay, o->value());
}
...
void LFOUI::cb_startphase_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Pstartphase, o->value());
}
...
void LFOUI::cb_randomness_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Prandomness, o->value());
}
...
void LFOUI::cb_LFOtype_i(Fl_Choice* o, void*) {
  pars->changepar(LFOParams::c_PLFOtype, o->value());
}
...
void LFOUI::cb_continous_i(Fl_Check_Button* o, void*) {
  pars->changepar(LFOParams::c_Pcontinous, o->value());
}
...
void LFOUI::cb_freqrand_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Pfreqrand, o->value());
}
...
void LFOUI::cb_stretch_i(WidgetPDial* o, void*) {
  pars->changepar(LFOParams::c_Pstretch, o->value());
}
...
Fl_Group* LFOUI::make_window() {
  { lfoui = new Fl_Group(0, 0, 230, 70);
    ...
    { lfoparamswindow = new Fl_Group(0, 0, 230, 70, "LFO");
      ...
      { WidgetPDial* o = freq = new WidgetPDial(5, 20, 30, 30, "Freq.");
      ...
      { WidgetPDial* o = randomness = new WidgetPDial(180, 7, 20, 20, "A.R.");
      ...
      { WidgetPDial* o = freqrand = new WidgetPDial(205, 7, 20, 20, "F.R.");
      ...
      { WidgetPDial* o = stretch = new WidgetPDial(144, 30, 20, 20, "Str.");
