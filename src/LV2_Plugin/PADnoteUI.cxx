...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/PADnoteUI.h"
// PADNoteUI.cc
...
void PADnoteUI::cb_Change_i(Fl_Button*, void*) {
  //
                ...
                oscui = new OscilEditor(pars->oscilgen, osc, cbwidget, applybutton, 0, synth);
}
...
void PADnoteUI::cb_Centre_i(Fl_Button*, void*) {
  //
                  pan->value(64);
                  pars->setPan(64);
                  randompan->value(pars->randomPan());
}
void PADnoteUI::cb_Centre(Fl_Button* o, void* v) {
  ((PADnoteUI*)(o->parent()->parent()->parent()->parent()->user_data()))->cb_Centre_i(o,v);
}

void PADnoteUI::cb_randompan_i(Fl_Light_Button* o, void*) {
  //
                  if (pars->randomPan())
                  {   // set to full left
                      pan->value(1);
...
void PADnoteUI::cb_randompan(Fl_Light_Button* o, void* v) {
...
Fl_Double_Window* PADnoteUI::make_window() {
  { Fl_Double_Window* o = padnotewindow = new Fl_Double_Window(535, 450, "PAD synth Parameters");
    ...
    { Fl_Tabs* o = new Fl_Tabs(0, 0, 535, 395);
      ...
      { harmonicstructuregroup = new Fl_Group(0, 20, 535, 375, "Harmonic Structure");
        ...
        { Fl_Box* o = new Fl_Box(160, 25, 315, 20, "Profile of One Harmonic (Frequency Distribution)");
          o->labelsize(12);
        } // Fl_Box* o
...
ncy)");
        ...
        { Fl_Group* o = new Fl_Group(5, 25, 240, 250, "AMPLITUDE");
          ...
          o->labelsize(12);
          o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
          { WidgetPDial* o = volume = new WidgetPDial(24, 42, 34, 34, "Volume");
          ...
          { WidgetPDial* o = vsns = new WidgetPDial(102, 42, 34, 34, "Vel Sens");
          ...
          { WidgetPDial* o = pan = new WidgetPDial(175, 42, 34, 34, "Pan");
            pan->tooltip("Panning - leftmost/zero is Random");
          ...
          { Fl_Button* o = new Fl_Button(213, 56, 10, 10, "Centre");
          ...
          { Fl_Light_Button* o = randompan = new Fl_Light_Button(197, 77, 13, 13, "Rand");
            randompan->tooltip("Random panning On/Off");
    ...
    { Fl_Button* o = applybutton = new Fl_Button(324, 410, 123, 24, "Apply Changes");
    ...
    { Fl_Button* o = new Fl_Button(466, 410, 61, 24, "Close");
      o->box(FL_THIN_UP_BOX);
      o->labelfont(1);
      o->labelsize(12);
      o->callback((Fl_Callback*)cb_Close);
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(205, 430, 25, 15, "C");
      o->box(FL_THIN_UP_BOX);
    ...
    { Fl_Button* o = new Fl_Button(235, 430, 25, 15, "P");
      o->box(FL_THIN_UP_BOX);
      o->color((Fl_Color)179);
      o->labelfont(1);
      o->labelsize(11);
    ...
    { Fl_Button* o = new Fl_Button(15, 410, 123, 24, "Export");
    ...
    string tname = synth->getGuiMaster()->set_part_window_title("PadSynth");
