...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/MicrotonalUI.h"
// Microtonal.cc
...
void MicrotonalUI::cb_nameinput_i(Fl_Input* o, void*) {
  microtonal->Pname = string(o->value());
}
...
void MicrotonalUI::cb_commentinput_i(Fl_Input* o, void*) {
  microtonal->Pcomment = string(o->value());
}
...
pings\"");
      ...
      { Fl_Input* o = nameinput = new Fl_Input(8, 64, 285, 25, "Name:");
        ...
        o->insert(microtonal->Pname.c_str());
      } // Fl_Input* nameinput
      ...
      { Fl_Input* o = commentinput = new Fl_Input(8, 104, 391, 25, "Comment:");
        ...
        o->insert(microtonal->Pcomment.c_str());
