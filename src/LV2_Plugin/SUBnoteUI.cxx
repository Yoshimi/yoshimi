...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/SUBnoteUI.h"
// SubNoteUI.cc
...
Fl_Group* SUBnoteharmonic::make_window() {
  { harmonic = new Fl_Group(0, 0, 90, 310);
    ...
    { Fl_Slider* o = mag = new Fl_Slider(0, 15, 10, 131);
    ...
    { Fl_Slider* o = bw = new Fl_Slider(0, 156, 10, 126);
    ...
    { Fl_Box* o = new Fl_Box(10, 216, 5, 5);
      o->box(FL_FLAT_BOX);
      o->color(FL_DARK3);
      if (n+1==MAX_SUB_HARMONICS) o->hide();
    } // Fl_Box* o
    { Fl_Box* o = new Fl_Box(0, 285, 10, 15, "01");
      o->labelfont(1);
      o->labelsize(9);
...
void SUBnoteUI::cb_randompan_i(Fl_Light_Button* o, void*) {
  //
...
void SUBnoteUI::cb_randompan(Fl_Light_Button* o, void* v) {
  ((SUBnoteUI*)(o->parent()->parent()->user_data()))->cb_randompan_i(o,v);
}

void SUBnoteUI::cb_Centre_i(Fl_Button*, void*) {
  //
              pan->value(64);
              pars->setPan(64);
              randompan->value(pars->randomPan());
}
void SUBnoteUI::cb_Centre(Fl_Button* o, void* v) {
  ((SUBnoteUI*)(o->parent()->parent()->user_data()))->cb_Centre_i(o,v);
}
...
Fl_Double_Window* SUBnoteUI::make_window() {
  { Fl_Double_Window* o = SUBparameters = new Fl_Double_Window(735, 475, "SUBsynth Parameters");
    SUBparameters->user_data((void*)(this));
    { Fl_Scroll* o = new Fl_Scroll(5, 140, 434, 325);
      o->type(1);
      o->box(FL_THIN_UP_BOX);
      { Fl_Pack* o = harmonics = new Fl_Pack(10, 145, 425, 325);
        harmonics->type(1);
    ...
    { Fl_Group* o = new Fl_Group(5, 5, 215, 135, "AMPLITUDE");
      ...
      { WidgetPDial* o = vol = new WidgetPDial(40, 20, 29, 29, "Volume");
        vol->tooltip("Volume");
      ...
      { WidgetPDial* o = vsns = new WidgetPDial(101, 20, 29, 29, "Veloc Sens");
      ...
      { WidgetPDial* o = pan = new WidgetPDial(160, 20, 29, 29, "Pan");
        pan->tooltip("Panning - zero/leftmost is Random");
        ...
        pan->align(Fl_Align(FL_ALIGN_BOTTOM_LEFT));
        pan->when(FL_WHEN_CHANGED);
        o->value(pars->PPanning);
      } // WidgetPDial* pan
      { Fl_Light_Button* o = randompan = new Fl_Light_Button(182, 49, 13, 13, "Rand");
        randompan->box(FL_NO_BOX);
        randompan->color((Fl_Color)35);
        randompan->selection_color(FL_RED);
        randompan->labelsize(10);
        randompan->callback((Fl_Callback*)cb_randompan);
        o->value(pars->randomPan());
      } // Fl_Light_Button* randompan
      { Fl_Button* o = new Fl_Button(192, 32, 10, 10, "Centre");
...
ncy)");
    ...
    { bandwidthsettingsui = new Fl_Group(220, 5, 220, 135, "BANDWIDTH");
      ...
      bandwidthsettingsui->labelsize(12);
    ...
    { Fl_Group* o = globalfiltergroup = new Fl_Group(440, 221, 290, 185, "FILTER");
      ...
      globalfiltergroup->labelsize(12);
    ...
    { Fl_Button* o = new Fl_Button(540, 449, 25, 15, "C");
      o->box(FL_THIN_UP_BOX);
    ...
    { Fl_Button* o = new Fl_Button(576, 449, 25, 15, "P");
      o->box(FL_THIN_UP_BOX);
      o->color((Fl_Color)179);
      o->labelfont(1);
      o->labelsize(11);
    ...
    { Fl_Group* o = new Fl_Group(440, 140, 290, 81, "OVERTONES");
      o->box(FL_THIN_UP_FRAME);
      o->labelfont(1);
      o->labelsize(12);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
      { Fl_Choice* o = spreadtype = new Fl_Choice(460, 171, 87, 20, "Overtones  Position");
      ...
      { WidgetPDial* o = spreadpar1 = new WidgetPDial(572, 166, 30, 30, "Par1");
      ...
      { WidgetPDial* o = spreadpar2 = new WidgetPDial(626, 166, 30, 30, "Par2");
    ...
    string tname = synth->getGuiMaster()->set_part_window_title("SubSynth");
