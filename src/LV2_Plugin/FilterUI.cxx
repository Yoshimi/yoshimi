...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/FilterUI.h"
// FilterUI.cc
...
void FilterUI::cb_analogfiltertypechoice_i(Fl_Choice* o, void*) {
  pars->Ptype=(int)o->value(); pars->changed=true;
}
...
void FilterUI::cb_filtertype_i(Fl_Choice* o, void*) {
  switchcategory((int)o->value()); pars->changed=true;
}
...
void FilterUI::cb_qdial_i(WidgetPDial* o, void*) {
  pars->Pq=(int)o->value(); formantfiltergraph->redraw();
}
...
void FilterUI::cb_vowel_counter_i(Fl_Counter* o, void*) {
  pars->Psequence[nseqpos].nvowel=(int) o->value();pars->changed=true;
}
...
void FilterUI::cb_Neg_i(Fl_Check_Button* o, void*) {
  pars->Psequencereversed=(int) o->value();pars->changed=true;
}
...
void FilterUI::cb_strchdial_i(WidgetPDial* o, void*) {
  pars->Psequencestretch=(int) o->value();pars->changed=true;
}
void FilterUI::cb_strchdial(WidgetPDial* o, void* v) {
  ((FilterUI*)(o->parent()->parent()->user_data()))->cb_strchdial_i(o,v);
}

void FilterUI::cb_Formants_i(Fl_Counter* o, void*) {
  pars->Pnumformants = (int) o->value();
            update_formant_window();
            pars->changed=true;
            formantfiltergraph->redraw();
}
void FilterUI::cb_Formants(Fl_Counter* o, void* v) {
  ((FilterUI*)(o->parent()->user_data()))->cb_Formants_i(o,v);
}

void FilterUI::cb_frsldial_i(WidgetPDial* o, void*) {
  pars->Pformantslowness=(int) o->value();pars->changed=true;
}
...
void FilterUI::cb_wvknob_i(WidgetPDial* o, void*) {
  pars->Pvowelclearness=(int) o->value();pars->changed = true;
}
...
ve)");
    ...
    { editbutton = new Fl_Button(10, 39, 50, 25, "Edit");
...
Fl_Double_Window* FilterUI::make_formant_window() {
  { formantparswindow = new Fl_Double_Window(700, 205, "Formant Filter Parameters");
    ...
    { Fl_Counter* o = new Fl_Counter(485, 15, 65, 20, "Formants");
      o->type(1);
      o->labelfont(1);
      o->labelsize(10);
      o->minimum(0);
      ...
      o->step(1);
      o->textsize(12);
      o->callback((Fl_Callback*)cb_Formants);
    ...
    { Fl_Value_Output* o = centerfreqvo = new Fl_Value_Output(510, 164, 42, 18, "C.f.");
    ...
    { Fl_Value_Output* o = octavesfreqvo = new Fl_Value_Output(510, 182, 42, 18, "Oct.");
    ...
    { Fl_Slider* o = cfknob = new Fl_Slider(556, 167, 84, 15);
      cfknob->type(5);
    ...
    { Fl_Slider* o = octknob = new Fl_Slider(556, 185, 84, 15);
      octknob->type(5);
    ...
    { Fl_Button* o = new Fl_Button(645, 170, 50, 25, "Close");
      o->box(FL_THIN_UP_BOX);
      o->labelsize(13);
