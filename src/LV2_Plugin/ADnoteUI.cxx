...
#include "/home/louis/Documents/prog/Yoshimi/github/yoshimi/src/LV2_Plugin/ADnoteUI.h"
// ADNoteUI.cc
...
void ADvoicelistitem::cb_voicevolume_i(Fl_Value_Slider* o, void*) {
  pars->VoicePar[nvoice].PVolume = lrint(o->value());
}
...
void ADvoicelistitem::cb_voiceresonanceenabled_i(Fl_Check_Button* o, void*) {
  pars->VoicePar[nvoice].Presonance = lrint(o->value());
}
...
void ADvoicelistitem::cb_voicelfofreq_i(Fl_Value_Slider* o, void*) {
  pars->VoicePar[nvoice].FreqLfo->Pintensity = lrint(o->value());
}
  ...
  { ADnoteVoiceListItem = new Fl_Group(0, 0, 615, 30);
    ...
    { Fl_Group* o = voicelistitemgroup = new Fl_Group(50, 0, 570, 25);
      ...
      { WidgetPDial* o = voicepanning = new WidgetPDial(215, 5, 20, 20);
        voicepanning->tooltip("Voice panning - zero/leftmost is Random");
      ...
      { Fl_Group* o = voiceoscil = new Fl_Group(60, 5, 30, 20);
        ...
        if (pars->VoicePar[nvoice].Pextoscil != -1) {osc->init(pars->VoicePar[pars->VoicePar[nvoice].Pextoscil].OscilSmp, synth);}
        voiceoscil->end();
      } // Fl_Group* voiceoscil
...
void ADvoicelistitem::init(ADnoteParameters *parameters,int nvoice_) {
  //
...
void ADvoiceUI::cb_Vol_i(Fl_Value_Slider* o, void*) {
  pars->VoicePar[nvoice].PFMVolume = lrint(o->value());
}
...
void ADvoiceUI::cb_V_i(Fl_Value_Slider* o, void*) {
  pars->VoicePar[nvoice].PFMVelocityScaleFunction = lrint(o->value());
}
...
void ADvoiceUI::cb_F_i(Fl_Value_Slider* o, void*) {
  pars->VoicePar[nvoice].PFMVolumeDamp = lrint(o->value()) + 64;
}
...
void ADvoiceUI::cb_fixedfreqetdial_i(WidgetPDial* o, void*) {
  pars->VoicePar[nvoice].PfixedfreqET = lrint(o->value());
}
...
void ADvoiceUI::cb_Detune1_i(Fl_Choice* o, void*) {
  pars->VoicePar[nvoice].PDetuneType = lrint(o->value()); detunevalueoutput->do_callback();
}
...
void ADvoiceUI::cb_Unison_i(Fl_Check_Button* o, void*) {
  int colr = FL_BLACK;
if (o->value() == 0)
{
...
void ADvoiceUI::cb_Unison(Fl_Check_Button* o, void* v) {
  ((ADvoiceUI*)(o->parent()->parent()->parent()->user_data()))->cb_Unison_i(o,v);
}

void ADvoiceUI::cb_unisonsize_i(Fl_Spinner* o, void*) {
  int tmp = lrint(o->value());
pars->VoicePar[nvoice].Unison_size = tmp;
int colr = FL_BLACK;
int i = -1;
while(true)
...
void ADvoiceUI::cb_Vib_i(WidgetPDial* o, void*) {
  pars->VoicePar[nvoice].Unison_vibratto = lrint(o->value());
}
...
void ADvoiceUI::cb_Invert_i(Fl_Choice* o, void*) {
  pars->VoicePar[nvoice].Unison_invert_phase = lrint(o->value());
}
...
void ADvoiceUI::cb_V1_i(WidgetPDial* o, void*) {
  pars->VoicePar[nvoice].Unison_vibratto_speed = lrint(o->value());
}
...
void ADvoiceUI::cb_Ph_i(WidgetPDial* o, void*) {
  pars->VoicePar[nvoice].Unison_phase_randomness=lrint(o->value());
}
...
void ADvoiceUI::cb_Vel_i(WidgetPDial* o, void*) {
  pars->VoicePar[nvoice].PAmpVelocityScaleFunction = lrint(o->value());
}
void ADvoiceUI::cb_Vel(WidgetPDial* o, void* v) {
  ((ADvoiceUI*)(o->parent()->parent()->parent()->user_data()))->cb_Vel_i(o,v);
}
...
void ADvoiceUI::cb_Centre_i(Fl_Button*, void*) {
  //
              voicepan->value(64);
              pars->setVoicePan(nvoice, 64);
              voicerandompan->value(pars->randomVoicePan(nvoice));
}
void ADvoiceUI::cb_Centre(Fl_Button* o, void* v) {
  ((ADvoiceUI*)(o->parent()->parent()->parent()->user_data()))->cb_Centre_i(o,v);
}

void ADvoiceUI::cb_voicerandompan_i(Fl_Light_Button* o, void*) {
  //
...
void ADvoiceUI::cb_voicerandompan(Fl_Light_Button* o, void* v) {
...
void ADvoiceUI::cb_Minus_i(Fl_Check_Button* o, void*) {
  pars->VoicePar[nvoice].PVolumeminus = lrint(o->value());
}
...
void ADvoiceUI::cb_Delay_i(Fl_Value_Slider* o, void*) {
  pars->VoicePar[nvoice].PDelay = lrint(o->value());
}
...
void ADvoiceUI::cb_bypassfiltercheckbutton_i(Fl_Check_Button* o, void*) {
  pars->VoicePar[nvoice].Pfilterbypass = lrint(o->value());
}
...
Fl_Group* ADvoiceUI::make_window() {
  { Fl_Group* o = ADnoteVoiceParameters = new Fl_Group(0, 0, 770, 580, "Voice");
    ...
    { Fl_Group* o = voiceparametersgroup = new Fl_Group(0, 0, 765, 580);
      ...
      { voicemodegroup = new Fl_Group(0, 5, 760, 575);
        { Fl_Group* o = voiceFMparametersgroup = new Fl_Group(530, 5, 230, 565, "MODULATOR");
          ...
          voiceFMparametersgroup->labelsize(11);
          ...
          { Fl_Group* o = new Fl_Group(535, 60, 220, 160, "Mod AMPLITUDE");
            ...
            { Fl_Value_Slider* o = new Fl_Value_Slider(540, 100, 160, 15, "V.Sns");
              o->tooltip("Velocity Sensing Function - rightmost/max to disable)");
              o->type(5);
              o->box(FL_FLAT_BOX);
              o->labelsize(11);
              o->maximum(127);
          ...
          { modoscil = new Fl_Group(535, 365, 220, 200, "Mod Oscilator");
            modoscil->box(FL_THIN_UP_BOX);
            modoscil->labelfont(1);
            modoscil->labelsize(12);
            ...
            { Fl_Button* o = changeFMoscilbutton = new Fl_Button(704, 368, 43, 12, "Change");
              changeFMoscilbutton->box(FL_THIN_UP_BOX);
              changeFMoscilbutton->labelfont(1);
              changeFMoscilbutton->labelsize(9);
          ...
          { Fl_Choice* o = new Fl_Choice(635, 40, 85, 20, "External Mod.");
            ...
            if (lrint(o->value())) {modoscil->deactivate(); modfrequency->deactivate();}
          } // Fl_Choice* o
...
ncy)");
        ...
        { Fl_Check_Button* o = new Fl_Check_Button(31, 543, 19, 15, "Unison");
          o->tooltip("Enable/Disable");
          o->box(FL_FLAT_BOX);
          o->down_box(FL_DOWN_BOX);
          o->labelfont(1);
          o->labelsize(12);
        ...
        { Fl_Group* o = unisongroup = new Fl_Group(80, 524, 445, 48);
          unisongroup->box(FL_PLASTIC_UP_BOX);
          unisongroup->color((Fl_Color)231);
          unisongroup->deactivate();
          { Fl_Spinner* o = unisonsize = new Fl_Spinner(90, 544, 40, 16, "Size");
            unisonsize->tooltip("Number of unison sub-voices");
            unisonsize->box(FL_THIN_UP_BOX);
            unisonsize->color(FL_BACKGROUND2_COLOR);
            unisonsize->labelfont(1);
            unisonsize->labelsize(11);
            unisonsize->minimum(2);
            unisonsize->maximum(50);
            unisonsize->value(2);
            unisonsize->textsize(12);
            unisonsize->callback((Fl_Callback*)cb_unisonsize);
            unisonsize->align(Fl_Align(FL_ALIGN_TOP_LEFT));
            int tmp = pars->VoicePar[nvoice].Unison_size;
            if (tmp < 2) tmp = 2;
            o->value(tmp);
          } // Fl_Spinner* unisonsize
          { WidgetPDial* o = new WidgetPDial(349, 540, 25, 25, "Stereo");
          ...
          { WidgetPDial* o = new WidgetPDial(384, 540, 25, 25, "Vib.");
            o->tooltip("Vibratto");
            o->box(FL_ROUND_UP_BOX);
            o->color(FL_BACKGROUND_COLOR);
            o->selection_color(FL_INACTIVE_COLOR);
          ...
          { Fl_Choice* o = new Fl_Choice(451, 545, 67, 15, "Invert");
          ...
          { Fl_Slider* o = new Fl_Slider(141, 545, 117, 16, "Frequency Spread");
          ...
          { Fl_Value_Output* o = unisonspreadoutput = new Fl_Value_Output(266, 545, 40, 17, "(cents)");
          ...
          { WidgetPDial* o = new WidgetPDial(420, 540, 25, 25, "V.speed");
          ...
          { WidgetPDial* o = new WidgetPDial(315, 540, 25, 25, "Ph.rnd");
      ...
      { amplitudegroup = new Fl_Group(5, 40, 240, 210, "AMPLITUDE");
        amplitudegroup->box(FL_THIN_UP_BOX);
        amplitudegroup->labelfont(1);
        amplitudegroup->labelsize(11);
        amplitudegroup->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
        { WidgetPDial* o = voicevolume = new WidgetPDial(42, 56, 34, 34, "Volume");
          voicevolume->tooltip("Volume");
        ...
        { WidgetPDial* o = new WidgetPDial(107, 56, 34, 34, "Vel Sens");
          o->tooltip("Velocity Sensing Function - rightmost/max disables)");
          o->box(FL_ROUND_UP_BOX);
          o->color(FL_BACKGROUND_COLOR);
          o->selection_color(FL_INACTIVE_COLOR);
          o->labeltype(FL_NORMAL_LABEL);
        ...
        { WidgetPDial* o = voicepan = new WidgetPDial(174, 56, 34, 34, "Pan");
          voicepan->tooltip("Voice panning - leftmost/zero gives random panning");
        ...
        { Fl_Button* o = new Fl_Button(213, 69, 10, 10, "Centre");
        ...
        { Fl_Light_Button* o = voicerandompan = new Fl_Light_Button(196, 91, 13, 13, "Rand");
          voicerandompan->tooltip("Voice random panning On/Off");
          voicerandompan->box(FL_NO_BOX);
          voicerandompan->color((Fl_Color)35);
          voicerandompan->selection_color(FL_RED);
          voicerandompan->labelsize(10);
          voicerandompan->callback((Fl_Callback*)cb_voicerandompan);
          voicerandompan->align(Fl_Align(72));
          o->value(pars->randomVoicePan(nvoice));
        ...
        { Fl_Check_Button* o = new Fl_Check_Button(10, 45, 50, 10, "Minus");
          o->tooltip("Invert volume control action");
          o->down_box(FL_DOWN_BOX);
          o->labelfont(1);
          o->labelsize(10);
      ...
      { Fl_Group* o = voicefiltergroup = new Fl_Group(245, 5, 285, 245, "FILTER");
        voicefiltergroup->box(FL_THIN_UP_FRAME);
        voicefiltergroup->labelfont(1);
        voicefiltergroup->labelsize(11);
      ...
      { Fl_Group* o = new Fl_Group(5, 5, 55, 35, "1");
        o->box(FL_THIN_UP_BOX);
      ...
      { Fl_Check_Button* o = bypassfiltercheckbutton = new Fl_Check_Button(416, 16, 14, 14, "Bypass Global F.");
    ...
    string tname = synth->getGuiMaster()->set_part_window_title("AddSynth Voice Oscillator");
...
void ADvoiceUI::init(ADnoteParameters *parameters,int nvoice_) {
  //
  	synth = parameters->getSynthEngine();
          pars = parameters;
          nvoice = nvoice_;
...
void ADnoteUI::cb_globalvolume_i(WidgetPDial* o, void*) {
  pars->GlobalPar.PVolume = lrint(o->value());
}
...
void ADnoteUI::cb_vsns_i(WidgetPDial* o, void*) {
  pars->GlobalPar.PAmpVelocityScaleFunction = lrint(o->value());
}
...
void ADnoteUI::cb_globalrandompan_i(Fl_Light_Button* o, void*) {
  //
...
void ADnoteUI::cb_globalrandompan(Fl_Light_Button* o, void* v) {
  ((ADnoteUI*)(o->parent()->parent()->user_data()))->cb_globalrandompan_i(o,v);
}

void ADnoteUI::cb_Centre1_i(Fl_Button*, void*) {
  //
              globalpan->value(64);
              pars->setGlobalPan(64);
              globalrandompan->value(pars->randomGlobalPan());
}
void ADnoteUI::cb_Centre1(Fl_Button* o, void* v) {
  ((ADnoteUI*)(o->parent()->parent()->user_data()))->cb_Centre1_i(o,v);
}

void ADnoteUI::cb_pstr_i(WidgetPDial* o, void*) {
  pars->GlobalPar.PPunchStrength = lrint(o->value());
}
...
void ADnoteUI::cb_pt_i(WidgetPDial* o, void*) {
  pars->GlobalPar.PPunchTime = lrint(o->value());
}
...
void ADnoteUI::cb_pstc_i(WidgetPDial* o, void*) {
  pars->GlobalPar.PPunchStretch = lrint(o->value());
}
...
void ADnoteUI::cb_pvel_i(WidgetPDial* o, void*) {
  pars->GlobalPar.PPunchVelocitySensing = lrint(o->value());
}
...
void ADnoteUI::cb_stereo_i(Fl_Check_Button* o, void*) {
  pars->GlobalPar.PStereo = lrint(o->value());
}
...
void ADnoteUI::cb_currentvoicecounter_i(Fl_Spinner* o, void*) {
  //
...
void ADnoteUI::cb_currentvoicecounter(Fl_Spinner* o, void* v) {
...
Fl_Double_Window* ADnoteUI::make_window() {
  { Fl_Double_Window* o = ADnoteGlobalParameters = new Fl_Double_Window(535, 405, "ADsynth Global Parameters of the Instrument");
    ...
    { amplitudegrp = new Fl_Group(5, 5, 240, 250, "AMPLITUDE");
      amplitudegrp->box(FL_THIN_UP_FRAME);
      amplitudegrp->labeltype(FL_EMBOSSED_LABEL);
      amplitudegrp->labelsize(11);
      amplitudegrp->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
      { WidgetPDial* o = globalvolume = new WidgetPDial(39, 22, 35, 35, "Volume");
      ...
      { WidgetPDial* o = vsns = new WidgetPDial(106, 22, 35, 35, "Vel Sens");
      ...
      { WidgetPDial* o = globalpan = new WidgetPDial(173, 22, 35, 35, "Pan");
        globalpan->tooltip("Global panning - leftmost/zero gives random panning");
        ...
        globalpan->align(Fl_Align(FL_ALIGN_BOTTOM_LEFT));
        globalpan->when(FL_WHEN_CHANGED);
        o->value(pars->GlobalPar.PPanning);
      } // WidgetPDial* globalpan
      { Fl_Light_Button* o = globalrandompan = new Fl_Light_Button(194, 57, 13, 13, "Rand");
        globalrandompan->box(FL_NO_BOX);
        globalrandompan->color((Fl_Color)35);
        globalrandompan->selection_color(FL_RED);
        globalrandompan->labelsize(10);
        globalrandompan->callback((Fl_Callback*)cb_globalrandompan);
        o->value(pars->randomGlobalPan());
      } // Fl_Light_Button* globalrandompan
      { Fl_Button* o = new Fl_Button(213, 36, 10, 10, "Centre");
        o->tooltip("Centre panning");
        o->box(FL_PLASTIC_ROUND_UP_BOX);
        o->color((Fl_Color)1);
        o->selection_color((Fl_Color)1);
    ...
    { Fl_Button* o = new Fl_Button(190, 375, 115, 25, "Show Voice List");
      o->labelsize(12);
      o->callback((Fl_Callback*)cb_Show);
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(5, 375, 180, 25, "Show Voice Parameters");
      o->labelfont(1);
      o->labelsize(12);
    ...
    string tname = synth->getGuiMaster()->set_part_window_title("AddSynth Global");
    o->copy_label(tname.c_str());
    ADnoteGlobalParameters->end();
  } // Fl_Double_Window* ADnoteGlobalParameters
  { Fl_Double_Window* o = ADnoteVoice = new Fl_Double_Window(765, 615, "ADsynth Voice Parameters");
    ...
    { currentvoicecounter = new Fl_Spinner(35, 584, 40, 24, "Current Voice");
      currentvoicecounter->labelfont(1);
      currentvoicecounter->labelsize(12);
      currentvoicecounter->maximum(8);
    ...
    { Fl_Button* o = new Fl_Button(655, 584, 90, 25, "Close");
      o->box(FL_THIN_UP_BOX);
      o->labelfont(1);
      o->labelsize(12);
      o->callback((Fl_Callback*)cb_Close1);
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(575, 589, 25, 15, "C");
      o->box(FL_THIN_UP_BOX);
      o->color((Fl_Color)179);
      o->labelfont(1);
      o->labelsize(11);
    ...
    { Fl_Button* o = new Fl_Button(605, 589, 25, 15, "P");
      o->box(FL_THIN_UP_BOX);
      o->color((Fl_Color)179);
      o->labelfont(1);
      o->labelsize(11);
    ...
    string tname = synth->getGuiMaster()->set_part_window_title("AddSynth Voice");
    o->copy_label(tname.c_str());
    ADnoteVoice->end();
  } // Fl_Double_Window* ADnoteVoice
  { Fl_Double_Window* o = ADnoteVoiceList = new Fl_Double_Window(650, 260, "ADsynth Voices list");
    ...
    { Fl_Button* o = new Fl_Button(554, 237, 62, 20, "Close");
      o->labelsize(12);
    ...
    string tname = synth->getGuiMaster()->set_part_window_title("AddSynth Voice List");
    o->copy_label(tname.c_str());
    ADnoteVoiceList->end();
...
ADnoteUI::ADnoteUI(ADnoteParameters *parameters) {
  //
  	synth = parameters->getSynthEngine();
          pars = parameters;
          nvoice = 0;
