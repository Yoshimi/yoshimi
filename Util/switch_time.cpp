...
int packed(int test)
{
    ...
    std::cout << "Time packed " << tv2.tv_sec - tv1.tv_sec << "." << tv2.tv_usec - tv1.tv_usec << std::endl;
    return result;
}
...
int sparse(int test)
{
    ...
    std::cout << "Time sparse " << tv2.tv_sec - tv1.tv_sec << "." << tv2.tv_usec - tv1.tv_usec << std::endl;
    return result;
}
